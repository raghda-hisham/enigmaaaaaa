...
})({"a4cHC":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "3d6ceb2b8dc63323";
"use strict";
...
},{}],"a6Jx3":[function(require,module,exports) {
...
var tl = _gsapDefault.default.timeline();
...
},{"gsap":"iCVLt","aos":"c4vXd","aos/dist/aos.css":"5RBV0","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"iCVLt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"3CNdC","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"c4vXd":[function(require,module,exports) {
...
!function(e, t) {
    ...
    function v1(e1, n1, o1) {
        var i1, a1, r1, c1, s1, u1, d1 = 0, l1 = !1, f1 = !1, v1 = !0;
        if ("function" != typeof e1) throw new TypeError(t);
        function y(t1) {
            var n2 = i1, o2 = a1;
            return i1 = a1 = void 0, d1 = t1, c1 = e1.apply(o2, n2);
        }
        function h(e2) {
            var t1 = e2 - u1;
            return (void 0) === u1 || t1 >= n1 || t1 < 0 || f1 && e2 - d1 >= r1;
        }
        function k() {
            var e2 = b();
            if (h(e2)) return x(e2);
            s1 = setTimeout(k, function(e3) {
                var t1 = n1 - (e3 - u1);
                return f1 ? p(t1, r1 - (e3 - d1)) : t1;
            }(e2));
        }
        function x(e2) {
            return s1 = void 0, v1 && i1 ? y(e2) : (i1 = a1 = void 0, c1);
        }
        function O() {
            var e2 = b(), t1 = h(e2);
            if (i1 = arguments, a1 = this, u1 = e2, t1) {
                if ((void 0) === s1) return (function(e3) {
                    return d1 = e3, s1 = setTimeout(k, n1), l1 ? y(e3) : c1;
                })(u1);
                if (f1) return s1 = setTimeout(k, n1), y(u1);
            }
            return (void 0) === s1 && (s1 = setTimeout(k, n1)), c1;
        }
        return n1 = w(n1) || 0, g(o1) && (l1 = !!o1.leading, r1 = (f1 = "maxWait" in o1) ? m(w(o1.maxWait) || 0, n1) : r1, v1 = "trailing" in o1 ? !!o1.trailing : v1), O.cancel = function() {
            (void 0) !== s1 && clearTimeout(s1), d1 = 0, i1 = u1 = a1 = s1 = void 0;
        }, O.flush = function() {
            return (void 0) === s1 ? c1 : x(b());
        }, O;
    }
    function g(e1) {
        var t1 = typeof e1;
    ...
    function w(e1) {
        ...
        if (g(e1)) {
            var t1 = "function" == typeof e1.valueOf ? e1.valueOf() : e1;
            e1 = g(t1) ? t1 + "" : t1;
        }
        if ("string" != typeof e1) return 0 === e1 ? e1 : +e1;
        e1 = e1.replace(i, "");
        var u1 = r.test(e1);
        return u1 || c.test(e1) ? s(e1.slice(2), u1 ? 2 : 8) : a.test(e1) ? n : +e1;
    }
    var y = function(e1, n1, o1) {
        var i1 = !0, a1 = !0;
        if ("function" != typeof e1) throw new TypeError(t);
        return g(o1) && (i1 = "leading" in o1 ? !!o1.leading : i1, a1 = "trailing" in o1 ? !!o1.trailing : a1), v1(e1, n1, {
            leading: i1,
            maxWait: n1,
            trailing: a1
        });
    ...
    function H(e1) {
        ...
        e1 = e1.replace(O, "");
        var n1 = E.test(e1);
        return n1 || N.test(e1) ? z(e1.slice(2), n1 ? 2 : 8) : j.test(e1) ? k : +e1;
    }
    var $ = function(e1, t3, n1) {
        var o1, i1, a1, r1, c1, s1, u1 = 0, d1 = !1, l1 = !1, f1 = !0;
        if ("function" != typeof e1) throw new TypeError(h);
        function m1(t4) {
            var n2 = o1, a2 = i1;
            return o1 = i1 = void 0, u1 = t4, r1 = e1.apply(a2, n2);
        }
        function p1(e2) {
            var n2 = e2 - s1;
            return (void 0) === s1 || n2 >= t3 || n2 < 0 || l1 && e2 - u1 >= a1;
        }
        function b1() {
            var e2 = S();
            if (p1(e2)) return v2(e2);
            c1 = setTimeout(b1, function(e3) {
                var n2 = t3 - (e3 - s1);
                return l1 ? M(n2, a1 - (e3 - u1)) : n2;
            }(e2));
        }
        function v2(e2) {
            return c1 = void 0, f1 && o1 ? m1(e2) : (o1 = i1 = void 0, r1);
        }
        function g1() {
            var e2 = S(), n2 = p1(e2);
            if (o1 = arguments, i1 = this, s1 = e2, n2) {
                if ((void 0) === c1) return (function(e3) {
                    return u1 = e3, c1 = setTimeout(b1, t3), d1 ? m1(e3) : r1;
                })(s1);
                if (l1) return c1 = setTimeout(b1, t3), m1(s1);
            }
            return (void 0) === c1 && (c1 = setTimeout(b1, t3)), r1;
        }
        return t3 = H(t3) || 0, D(n1) && (d1 = !!n1.leading, a1 = (l1 = "maxWait" in n1) ? T(H(n1.maxWait) || 0, t3) : a1, f1 = "trailing" in n1 ? !!n1.trailing : f1), g1.cancel = function() {
            (void 0) !== c1 && clearTimeout(c1), u1 = 0, o1 = s1 = i1 = c1 = void 0;
        }, g1.flush = function() {
            return (void 0) === c1 ? r1 : v2(S());
        }, g1;
    }, W = function() {
    };
    function P(e1) {
        e1 && e1.forEach(function(e2) {
            var t3 = Array.prototype.slice.call(e2.addedNodes), n1 = Array.prototype.slice.call(e2.removedNodes);
            if ((function e3(t4) {
                var n2 = void 0, o1 = void 0;
                for(n2 = 0; n2 < t4.length; n2 += 1){
                    if ((o1 = t4[n2]).dataset && o1.dataset.aos) return !0;
                    if (o1.children && e3(o1.children)) return !0;
                }
                return !1;
            })(t3.concat(n1))) return W();
        });
    }
    function Y() {
    ...
    var _ = {
        ...
        ready: function(e1, t3) {
            var n1 = window.document, o1 = new (Y())(P);
            W = t3, o1.observe(n1.documentElement, {
                childList: !0,
                subtree: !0,
                removedNodes: !0
            });
        ...
        function e1(e2, t3) {
            for(var n1 = 0; n1 < t3.length; n1++){
                var o1 = t3[n1];
                o1.enumerable = o1.enumerable || !1, o1.configurable = !0, "value" in o1 && (o1.writable = !0), Object.defineProperty(e2, o1.key, o1);
            }
        }
        return function(t3, n1, o2) {
            return n1 && e1(t3.prototype, n1), o2 && e1(t3, o2), t3;
        };
    }(), I = Object.assign || function(e1) {
        for(var t3 = 1; t3 < arguments.length; t3++){
            var n1 = arguments[t3];
            for(var o2 in n1)Object.prototype.hasOwnProperty.call(n1, o2) && (e1[o2] = n1[o2]);
        }
        return e1;
    ...
    var U = new (function() {
        ...
        return F(e1, [
            {
                ...
                value: function() {
                    var e2 = R();
                    return !(!K.test(e2) && !G.test(e2.substr(0, 4)));
                }
            },
            {
                key: "mobile",
                value: function() {
                    var e2 = R();
                    return !(!J.test(e2) && !Q.test(e2.substr(0, 4)));
                }
            },
            {
                key: "tablet",
        ...
        var n2 = void 0;
        return U.ie11() ? (n2 = document.createEvent("CustomEvent")).initCustomEvent(e1, !0, !0, {
            detail: t3
        }) : n2 = new CustomEvent(e1, {
            detail: t3
        }), document.dispatchEvent(n2);
    }, X = function(e1) {
        return e1.forEach(function(e2, t3) {
            return (function(e3, t4) {
                var n2 = e3.options, o3 = e3.position, i1 = e3.node, a1 = (e3.data, function() {
                    e3.animated && ((function(e4, t5) {
                        t5 && t5.forEach(function(t6) {
                            return e4.classList.remove(t6);
                        });
                    })(i1, n2.animatedClassNames), V("aos:out", i1), e3.options.id && V("aos:in:" + e3.options.id, i1), e3.animated = !1);
                });
                n2.mirror && t4 >= o3.out && !n2.once ? a1() : t4 >= o3.in ? e3.animated || ((function(e4, t5) {
                    t5 && t5.forEach(function(t6) {
                        return e4.classList.add(t6);
                    });
                })(i1, n2.animatedClassNames), V("aos:in", i1), e3.options.id && V("aos:in:" + e3.options.id, i1), e3.animated = !0) : e3.animated && !n2.once && a1();
            })(e2, window.pageYOffset);
        });
    }, Z = function(e1) {
        for(var t3 = 0, n2 = 0; e1 && !isNaN(e1.offsetLeft) && !isNaN(e1.offsetTop);)t3 += e1.offsetLeft - ("BODY" != e1.tagName ? e1.scrollLeft : 0), n2 += e1.offsetTop - ("BODY" != e1.tagName ? e1.scrollTop : 0), e1 = e1.offsetParent;
        return {
            top: n2,
            left: t3
        };
    }, ee = function(e1, t3, n2) {
        var o3 = e1.getAttribute("data-aos-" + t3);
        if ((void 0) !== o3) {
            if ("true" === o3) return !0;
        ...
        return e1.forEach(function(e2, n2) {
            var o3 = ee(e2.node, "mirror", t3.mirror), i1 = ee(e2.node, "once", t3.once), a1 = ee(e2.node, "id"), r1 = t3.useClassNames && e2.node.getAttribute("data-aos"), c1 = [
                t3.animatedClassName
            ].concat(r1 ? r1.split(" ") : []).filter(function(e3) {
                return "string" == typeof e3;
            });
            t3.initClassName && e2.node.classList.add(t3.initClassName), e2.position = {
                in: (function(e3, t4, n3) {
                    var o4 = window.innerHeight, i2 = ee(e3, "anchor"), a2 = ee(e3, "anchor-placement"), r2 = Number(ee(e3, "offset", a2 ? 0 : t4)), c2 = a2 || n3, s1 = e3;
                    i2 && document.querySelectorAll(i2) && (s1 = document.querySelectorAll(i2)[0]);
                    var u1 = Z(s1).top - o4;
                    switch(c2){
                        case "top-bottom":
                            break;
                        case "center-bottom":
                            u1 += s1.offsetHeight / 2;
                            break;
                        case "bottom-bottom":
                            u1 += s1.offsetHeight;
                            break;
                        case "top-center":
                            ...
                            break;
                        case "center-center":
                            u1 += o4 / 2 + s1.offsetHeight / 2;
                            break;
                        case "bottom-center":
                            u1 += o4 / 2 + s1.offsetHeight;
                            break;
                        case "top-top":
                            u1 += o4;
                            break;
                        case "bottom-top":
                            u1 += o4 + s1.offsetHeight;
                            break;
                        case "center-top":
                            u1 += o4 + s1.offsetHeight / 2;
                    }
                    return u1 + r2;
                })(e2.node, t3.offset, t3.anchorPlacement),
                out: o3 && (function(e3, t4) {
                    window.innerHeight;
                    var n3 = ee(e3, "anchor"), o4 = ee(e3, "offset", t4), i2 = e3;
                    return n3 && document.querySelectorAll(n3) && (i2 = document.querySelectorAll(n3)[0]), Z(i2).top + i2.offsetHeight - o4;
                })(e2.node, t3.offset)
            }, e2.options = {
                once: i1,
                mirror: o3,
                animatedClassNames: c1,
                id: a1
            };
        }), e1;
    }, ne = function() {
        var e1 = document.querySelectorAll("[data-aos]");
        return Array.prototype.map.call(e1, function(e2) {
            return {
                node: e2
            };
        });
        ...
        oe.forEach(function(e1, t3) {
            e1.node.removeAttribute("data-aos"), e1.node.removeAttribute("data-aos-easing"), e1.node.removeAttribute("data-aos-duration"), e1.node.removeAttribute("data-aos-delay"), ae.initClassName && e1.node.classList.remove(ae.initClassName), ae.animatedClassName && e1.node.classList.remove(ae.animatedClassName);
        });
    }, de = function(e1) {
        return !0 === e1 || "mobile" === e1 && U.mobile() || "phone" === e1 && U.phone() || "tablet" === e1 && U.tablet() || "function" == typeof e1 && !0 === e1();
    };
    return {
        init: function(e1) {
            return ae = I(ae, e1), oe = ne(), ae.disableMutationObserver || _.isSupported() || (console.info('\n      aos: MutationObserver is not supported on this browser,\n      code mutations observing has been disabled.\n      You may have to call "refreshHard()" by yourself.\n    '), ae.disableMutationObserver = !0), ae.disableMutationObserver || _.ready("[data-aos]", se), de(ae.disable) || re() ? ue() : (document.querySelector("body").setAttribute("data-aos-easing", ae.easing), document.querySelector("body").setAttribute("data-aos-duration", ae.duration), document.querySelector("body").setAttribute("data-aos-delay", ae.delay), -1 === [
                "DOMContentLoaded",
                "load"
...
},{}],"5RBV0":[function() {},{}]},["a4cHC","a6Jx3"], "a6Jx3", "parcelRequire70e5")

//# sourceMappingURL=about.8dc63323.js.map
